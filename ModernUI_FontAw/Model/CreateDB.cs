...
namespace ModernUI_FontAw.Model
{
    public class CreateDB :
       //CreateDatabaseIfNotExists<Admin> //CSDL chưa tồn tại sẽ tạo ra CSDL mới, nếu tồn tại rồi sẽ không khưởi tạo
                                        ...
                                        DropCreateDatabaseAlways<Admin> // Mỗi lần chạy lại thì sẽ xóa cái cũ và tahy cái mới
    {
        protected override void Seed(Admin context)
        {
            ...
            {
                new Computer{Name_PC = "May 1", ID_Customer=1, Status = true},
                new Computer{Name_PC = "May 2", ID_Customer=2, Status = false},
                new Computer{Name_PC = "May 3", ID_Customer=3, Status = true},
            });
